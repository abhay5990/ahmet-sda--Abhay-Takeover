"""Parse manual-entry payloads for the Xbox slice."""
...
class XboxManualSource:
    """Normalized Xbox fields from manual input."""
...
class XboxManualSourceAdapter:
    """Extract Xbox data from a manual-entry source envelope."""

    def parse(self, raw_data: dict[str, Any] | None) -> XboxManualSource | None:
