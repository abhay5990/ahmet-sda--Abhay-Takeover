"""Parse manual-entry payloads for the PSN slice."""
...
class PsnManualSource:
    """Normalized PSN fields from manual input."""
...
class PsnManualSourceAdapter:
    """Extract PSN data from a manual-entry source envelope."""

    def parse(self, raw_data: dict[str, Any] | None) -> PsnManualSource | None:
