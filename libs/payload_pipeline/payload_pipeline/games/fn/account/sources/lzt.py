...
class FortniteLztSourceAdapter:
    ...
    def parse(self, raw_data: dict[str, Any] | None) -> FortniteLztSource | None:
        ...
        return FortniteLztSource(
            ...
            pickaxe_count=self._to_int(payload.get("fortnite_pickaxe_count") or payload.get("fortnite_shop_pickaxes_count"), default=0),
            dance_count=self._to_int(payload.get("fortnite_dance_count") or payload.get("fortnite_shop_dances_count"), default=0),
            glider_count=self._to_int(payload.get("fortnite_glider_count") or payload.get("fortnite_shop_gliders_count"), default=0),
