"""Parse manual-entry payloads for the Clash Royale slice."""
...
class CrManualSource:
    """Normalized Clash Royale fields from manual input."""
...
class CrManualSourceAdapter:
    """Extract Clash Royale data from a manual-entry source envelope."""

    def parse(self, raw_data: dict[str, Any] | None) -> CrManualSource | None:
