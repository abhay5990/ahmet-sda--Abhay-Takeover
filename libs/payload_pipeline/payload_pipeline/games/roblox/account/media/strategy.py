"""Static media strategy for Roblox accounts."""
...
class RobloxMediaStrategy(StaticAccountMediaStrategy):
    """Prepare the bundled Roblox account image."""
    ...
    def prepare(self, subject: RobloxResolvedAccount, request: PipelineRequest) -> list[str]:
