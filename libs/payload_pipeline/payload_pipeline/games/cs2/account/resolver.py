...
class CS2Resolver:
    ...
    def _resolve_lzt(self, lzt, request: PipelineRequest) -> CS2ResolvedAccount:
        ...
        return CS2ResolvedAccount(
            ...
            credentials=credentials,
            rank_id=lzt.rank_id,
            wingman_rank_id=lzt.wingman_rank_id,
            premier_elo=lzt.premier_elo,
            is_prime=lzt.is_prime,
            cs2_hours=lzt.cs2_hours,
            profile_rank=lzt.profile_rank,
            medal_names=lzt.medal_names,
            medal_count_raw=lzt.medal_count,
            steam_level=lzt.steam_level,
            country=lzt.country,
            has_faceit=lzt.has_faceit,
            has_email_access=not lzt.credentials.is_empty and bool(lzt.credentials.email_login),
            has_vac_ban=lzt.has_vac_ban,
            market_banned=lzt.market_banned,
            game_count=lzt.game_count,
            game_titles=lzt.game_titles,
            games=lzt.games,
        )
