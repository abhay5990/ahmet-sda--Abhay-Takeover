"""Parse manual-entry payloads for the Steam slice."""
...
class SteamManualSource:
    """Normalized Steam fields from manual input."""
...
class SteamManualSourceAdapter:
    """Extract Steam data from a manual-entry source envelope."""

    def parse(self, raw_data: dict[str, Any] | None) -> SteamManualSource | None:
