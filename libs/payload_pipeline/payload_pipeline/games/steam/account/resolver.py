...
class SteamResolver:
    ...
    def _resolve_lzt(
        ...
        return SteamResolvedAccount(
            ...
            is_limited=lzt.is_limited,
            cs2_rank_id=lzt.cs2_rank_id,
            cs2_profile_rank=lzt.cs2_profile_rank,
            cs2_win_count=lzt.cs2_win_count,
            market_ban_end_date=lzt.market_ban_end_date,
            dota2_mmr=lzt.dota2_mmr,
            dota2_win_count=lzt.dota2_win_count,
            dota2_lose_count=lzt.dota2_lose_count,
            rust_kills=lzt.rust_kills,
            rust_deaths=lzt.rust_deaths,
        )
