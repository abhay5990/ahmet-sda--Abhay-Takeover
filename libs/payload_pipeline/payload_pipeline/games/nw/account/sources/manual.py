"""Parse manual-entry payloads for the New World account slice."""
...
class NwManualSource:
    """Normalized New World account fields from manual input."""
...
class NwManualSourceAdapter:
    """Extract New World account data from a manual-entry source envelope."""

    def parse(self, raw_data: dict[str, Any] | None) -> NwManualSource | None:
